...
const Web =()=>{
    ...
    <div className="web">
        <h1>Reshaping Dynamics of Modern-Age<br/>
Businesses With Our Solutions</h1>
       <h2>Your doorway of assured growth through the commitment of qualitative delivery</h2>
       <div className="mobile">
        <div className="mob1 ">
            ...
            <h2>Captivating Design <br/>Services</h2>  
            <h4>A good design is the first good impression<br/> you would make on your customers.</h4>   
        </div>
        <div className="mob2 "><h2>Web and Mobile App <br/>Development</h2>
        <p>Begin your journey to create revenue-generating<br/> digital solutions for your business.</p>
        </div>
        <div className="mob3 "> 
        <div className="over">
